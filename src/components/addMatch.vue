  ...
  export default {
    data() {
      return {
        ...
        player1: "",
        player2: "",
        date: new Date().addHours(7).toISOString().substr(0, 10),
        dateFormatted: this.formatDate(new Date().addHours(7).toISOString().substr(0, 10)),
        menu2: false,
        score: "",
      ...
      saveResults() {
        ...
        this.$store.dispatch("addMatchResult", request)
            .then(() => {
              ...
              this.player2 = "";
              this.score = "";
              this.date = new Date().addHours(7).toISOString().substr(0, 10);
            })
            .catch(error => {
